...
# Description
[Examples](https://nqcp.github.io/NQCP-CrystalGrowth-git-RHEED_camera_script/example_notebooks/index.html)
# Installation
...
If you have gotten 'RHEED_camera_script' from source, you may run the tests locally.

Install `RHEED_camera_script` along with its test dependencies into your virtual environment by executing the following in the root folder
...
If you have gotten `RHEED_camera_script` from source, you may build the docs locally.

Install `RHEED_camera_script` along with its documentation dependencies into your virtual environment by executing the following in the root folder
