...
output_filename = "output_video.avi"  # Set the output video file name
fourcc = cv2.VideoWriter_fourcc(*'XVID')
frame_rate = 10  # Adjust the frame rate as needed
frame_width = 1440  # Adjust the frame width as needed
frame_height = 1080  # Adjust the frame height as needed
out = cv2.VideoWriter(output_filename, fourcc, frame_rate, (frame_width, frame_height))


#os.add_dll_directory(os.getcwd() + "\\dlls")
os.add_dll_directory(r'C:\Users\qgh880\Desktop\Scientific_Camera_Interfaces_Windows-2.1\Scientific Camera Interfaces\SDK\Python Toolkit\dlls\64_lib')
        ...
        try:
            while True:
                ...
                if frame is not None:
                    ...
                    nd_image_array[:,:,1] = numpy_shaped_image*0
                    nd_image_array[:,:,2] = numpy_shaped_image*0
                    
                    out.write(nd_image_array) 
